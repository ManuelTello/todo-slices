    ...
    public partial class InitialDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EntryColumns", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EntryColumns_Boards_BoardId",
                        column: x => x.BoardId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateCreated = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    DateDeleted = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    EntryColumnId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EntryRows", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EntryRows_EntryColumns_EntryColumnId",
                        column: x => x.EntryColumnId,
                        principalTable: "EntryColumns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EntryColumns_BoardId",
                table: "EntryColumns",
                column: "BoardId");

            migrationBuilder.CreateIndex(
                name: "IX_EntryRows_EntryColumnId",
                table: "EntryRows",
                column: "EntryColumnId");
        }
